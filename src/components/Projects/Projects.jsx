            ...
            <Col xl={4} lg={6} md={12} sm={12} className="d-flex flex-column pb-md-0 pb-sm-5 project">
              <Card bg="light" border="info" className="shadow mb-4">
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <Card.Text className="techDescription">axios | Hooks | HOCs | redux | react-redux | redux-thunk | node-saas |
            ...
            <Col xl={4} lg={6} md={12} sm={12} className="d-flex flex-column pb-md-0 pb-sm-5 project">
              <Card bg="light" border="info" className="shadow mb-4">
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <Card.Text className="mt-2">Additional tools and features used in the project:</Card.Text>
                  <Card.Text className="techDescription">axios | formik | yup | react-router-dom | reselect | Hooks | HOCs | swiper |
                    react-yandex-maps | SASS | react-icons | emailJS | git</Card.Text>


                  <CardGroup className="d-flex justify-content-center mt-auto">
                    <Button
                      variant="info"
                      href="https://rtl56.gacv.ru"
                      target="_blank">Leasing company</Button>
                  </CardGroup>
              ...
              <Card bg="light" border="info" className="shadow mb-4">
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <Card.Text className="techDescription"> react bootstrap | formik | yup | redux | react-redux | redux-thunk | react-router-dom |
                    hooks | HOCs | SCSS | git</Card.Text>

                  <div className="d-flex justify-content-center mt-auto"><Button
                    variant="info"
                    href="https://tasklist.gacv.ru"
                    target="_blank">Task list</Button></div>

                </Card.Body>
              </Card>
            </Col>

            <Col xl={6} lg={6} md={12} sm={12} className="d-flex flex-column pb-md-0 pb-sm-5 project">
              <Card bg="light" border="info" className="shadow mb-4">
                <div className='rnWrapper'>
                  <div className="rnVideoWrapper">
                    <ReactPlayer url={rn} controls={true} playing={false} width={'100%'} height={'auto'}/>
                  </div>
                  <div>
                    <Card.Body className="d-flex flex-column">
                      ...
                      <ListGroup variant="flush">
                        <div  className="font-weight-bold mainTech ">
                          {["JavaScript", "React Native", "Node JS", "MongoDB", "Express"].map((item, i) => (
                            <div key={i} className=" pb-lg-3 pb-md-3 pb-sm-3 pb-2"><ListGroup.Item
                              className="listItem">{item}</ListGroup.Item></div>
                          ))}
                        </div>

                      </ListGroup>
                      <Card.Text className="mt-2"> Additional tools and features used in the project:</Card.Text>
                      <Card.Text className="techDescription"> axios | formik | yup | redux | react-redux | redux-thunk | redux-persist | moment | lodash |
                        git</Card.Text>
